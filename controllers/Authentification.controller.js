...
exports.login = async (req, res) => {
  ...
  try {
    ...
    const module = await Module.findOne({ etudiants: etudiant?._id }).populate('etudiants').exec();
    ...
    res.json({ token, module:{
      ...
      nomUtilisateur: compte.nomUtilisateur, role: compte.role, estActive: compte.estActive
     } });
  } catch (error) {
    console.error(error);
